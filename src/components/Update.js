...
function Update() {
  ...
  useEffect(()=>{
    ...
    const fetchData = async ()=>{
      const res = await axios.get(`https://alive-fawn-fedora.cyclic.cloud/api/posts/${id}`)
  ...
  const handleSubmit =async (e)=>{
    ...
    toggleProcess()
    const res = await axios.patch(`https://alive-fawn-fedora.cyclic.cloud/api/posts/${id}`,{title,description:des,code,author,tags:array,email})
    toggleProcess()
